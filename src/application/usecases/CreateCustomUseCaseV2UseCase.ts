...
import { createAgentChannelV2 } from '../../core/repositories/channel.repository';

export class CreateCustomUseCaseV2UseCase {
    ...
    async execute(userContext: IUserContext, payload: any) {
        ...
        // Create external resources (AI assistant + v2 channel) — same as v1
        ...
        const createdAgentChannel = await createAgentChannelV2(userContext.org_id, usecase?.title, createdAIAssistant?.id ?? '');
